...
<%@page import="Logica.Cliente, java.text.SimpleDateFormat, java.util.Date"%>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <h4>Modificación de Clientes</h4>
              <h6 class="font-weight-light">Edite los datos de su cliente</h6>
              <form class="pt-3" action="SvModificarCl" method="get" id="formulario">
                ...
                <div class="form-group">
                    <input type="text" class="form-control form-control-lg" name="nombre" id="nombre" value="<%=clie.getNombre()%>" pattern="[a-zA-ZÀ-ÿ\s]{1,20}" title="Sólo puede ingresar letras. Máximo 20 caracteres." required>
                </div>
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" name="apellido" id="apellido" value="<%=clie.getApellido()%>" pattern="[a-zA-ZÀ-ÿ\s]{1,20}" title="Sólo puede ingresar letras. Máximo 20 caracteres." required>
                </div> 
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" name="direccion" id="direccion" value="<%=clie.getDireccion()%>" pattern="[a-zA-Z0-9\s]{7,55}" title="Sólo puede ingresar letras y números. Máximo 55 caracteres." required>
                </div> 
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" name="dni" id="dni" value="<%=clie.getDni()%>" pattern="\d{7,8}" title="Ingrese de 7 a 8 números" required>
                </div> 
                 <div class="form-group">
                  <input type="date" class="form-control form-control-lg" name="fecha_nac" id="fecha_nac" value="<%=strDate%>" required>
                </div> 
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" name="nacionalidad" id="nacionalidad" value="<%=clie.getNacionalidad()%>" pattern="[a-zA-ZÀ-ÿ\s]{1,20}" title="Sólo puede ingresar letras. Máximo 20 caracteres." required>
                </div> 
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" name="celular" id="celular" value="<%=clie.getCelular()%>" pattern="\d{7,14}" title="Ingrese de 7 a 14 números" required>
                </div> 
                <div class="form-group">
                  <input type="email" class="form-control form-control-lg" name="email" id="email" value="<%=clie.getEmail()%>" required>
                </div>
                    <input type="hidden" name="id" value="<%=clie.getId()%>">
                <div class="mt-3">
                  <button type="submit" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" value="enviar" id="btn-enviar">Modificar cliente</button>
                </div>
                <%}%>
              </form>
            </div>
