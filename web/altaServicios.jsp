        ...
        <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <h4 class="card-title">Alta de servicios</h4>
                  <h5 class="font-weight-light">Ingrese los datos del servicio</h5><br>
                  <form class="forms-sample" action="SvServicio" method="POST" id="formulario">
                    <div class="form-group">
                      <label for="exampleInputName1">Nombre</label>
                      <input type="text" class="form-control" id="nombre" name="nombre" pattern=".{1,55}" title="Ingrese máximo 55 caracteres." required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail3">Descripción breve</label>
                      <textarea type="text" class="form-control" id="descripcion_breve" name="descripcion_breve" pattern=".{1,120}" title="Ingrese máximo 120 caracteres." required></textarea>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputCity1">Destino</label>
                      <input type="text" class="form-control" id="destino_servicio" name="destino_servicio" pattern="[a-zA-ZÀ-ÿ\s]{1,35}" title="Sólo puede ingresar letras. Máximo 35 caracteres." required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="costo_servicio" name="costo_servicio" pattern="\d{1,8}(\.\d{1,2})?" title="Ingrese máximo 8 números (máximo dos decimales opcionales, separador decimal: ." required>
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-primary mr-2" value="enviar" id="btn-enviar">Crear servicio</button>
                  </form>
                </div>
              </div>
            </div>  
