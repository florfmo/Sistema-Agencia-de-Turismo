...
<%@page import="java.util.List, Logica.Cliente, Logica.Controladora, Logica.Usuario, java.text.SimpleDateFormat, java.util.Date"%>
<!DOCTYPE html>
<html lang="en">
...
<body>
        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <h4>Modificación de usuario y contraseña</h4>
              <h6 class="font-weight-light">Edite su usuario y contraseña (se cerrará la sesión para confirmar el cambio)</h6>
              <form class="pt-3" action="SvModificarUsu" method="GET">
                ...
                <div class="form-group">
                    <input type="text" class="form-control form-control-lg" id="nombre_usuario" name="nombre_usuario" placeholder="Usuario" value="<%=usuario%>" pattern="[a-zA-Z0-9]{6,10}" title="Ingrese de 6 a 10 caracteres. Sólo letras y números." required>
                </div>
                <div class="form-group">
                    <input type="password" class="form-control form-control-lg" id="contrasenia" name="contrasenia" placeholder="Contraseña" value="<%=contrasenia%>" pattern=".{4,12}" title="Ingrese de 4 a 12 caracteres." required>
                </div>
                <div class="mt-3">
                  <button onclick="geek()" type="submit" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" value="enviar" id="btn-enviar">Guardar cambios y cerrar sesión</button>
                </div>
                <div class="mb-2">
                </div>
  ...
  <script>
        function geek() {
            confirm("¿Desea cambiar la contraseña y cerrar sesión?");
        }
    </script>
</body>
