...
<%@page import="java.util.List, java.util.Date, Logica.Controladora, Logica.PaqueteTuristico, Logica.ServicioTuristico, java.text.SimpleDateFormat, java.text.DecimalFormat"%>
<!DOCTYPE html>
<html lang="en">
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped">
                      ...
                      <tbody>
                        ...
                        %>
                        <tr>
                        <%int codigo_paquete = paq.getCodigo_paquete();
                        List<ServicioTuristico> lista_servicios = paq.getLista_servicios_incluidos();
                        double costo = paq.getCosto_paquete();
                        String costo_paquete = format.format(costo);
                        %>
                          <td class="py-1">
                            <b><%=codigo_paquete%></b>
                          </td>
                          <td>
                            <%for (ServicioTuristico serv : lista_servicios) {
                                Date fecha_servicio = serv.getFecha_servicio();
                                String strDate = formatter.format(fecha_servicio); %> 
                                <%=serv.getCodigo_servicio()%>: <%=serv.getNombre()%>, <%=serv.getDestino_servicio()%>, <%=strDate%> (<%=serv.getTipo_servicio()%>)<br><br>
                            <% }%>
                          </td>
                          <td>
                            <%=costo_paquete%>
                          ...
                          <td>
                            <form name="frmModificarPaquete" action="SvModificarPaq" method="post">
                          ...
                          <td>
                            <form name="frmEliminarPaquete" action="SvEliminarPaq" method="post">
                            <input type="hidden" name="codigo_paquete" value="<%=codigo_paquete%>">
