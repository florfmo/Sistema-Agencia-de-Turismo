...
<%@page import="Logica.Cliente, Logica.Cliente, Logica.Empleado, Logica.ServicioTuristico, Logica.PaqueteTuristico, Logica.Controladora, java.text.SimpleDateFormat, java.util.Date, java.util.List"%>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <h4 class="card-title">Alta de venta de paquetes</h4>
                  <h5 class="font-weight-light">Ingrese los datos de la venta</h5><br>
                  <form class="forms-sample" action="SvVenta" method="POST" id="formulario">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" id="paquete" name="paquete">
                        ...
                        %>
                        <option value="<%=paq.getCodigo_paquete()%>">
                            <%=paq.getCodigo_paquete()%>: <%=paq.getLista_servicios_incluidos().size()%> Servicios - <%=paq.getCosto_paquete()%>
                        </option>
                        <%}%>
                      </select>
                    </div>
                    <button type="submit" class="btn btn-primary mr-2" value="enviar" id="btn-enviar">Crear venta</button>
                  </form>
                </div>
              </div>
            </div>  
