        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <h6 class="font-weight-light">Ingrese los datos de su empleado</h6>
              <form class="pt-3" action="SvEmpleado" method="POST" id="formulario">
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" name="nombre" id="nombre" placeholder="Nombre" pattern="[a-zA-ZÀ-ÿ\s]{1,20}" title="Sólo puede ingresar letras. Máximo 20 caracteres." required>
                </div>
                <div class="form-group"> 
                  <input type="text" class="form-control form-control-lg" name="apellido" id="apellido" placeholder="Apellido" pattern="[a-zA-ZÀ-ÿ\s]{1,20}" title="Sólo puede ingresar letras. Máximo 20 caracteres." required>
                </div> 
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" name="direccion" id="direccion" placeholder="Dirección" pattern="[a-zA-Z0-9\s]{7,55}" title="Sólo puede ingresar letras y números. Máximo 55 caracteres." required>
                </div> 
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" name="dni" id="dni" placeholder="DNI" pattern="\d{7,8}" title="Ingrese de 7 a 8 números." required>
                </div> 
                 <div class="form-group">
                  <input type="date" class="form-control form-control-lg" name="fecha_nac" id="fecha_nac" placeholder="Fecha de nacimiento" required>
                </div> 
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" name="nacionalidad" id="nacionalidad" placeholder="Nacionalidad" pattern="[a-zA-ZÀ-ÿ\s]{1,20}" title="Sólo puede ingresar letras. Máximo 20 caracteres." required>
                </div> 
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" name="celular" id="celular" placeholder="Celular" pattern="\d{7,14}" title="Ingrese de 7 a 14 números." required>
                </div> 
                <div class="form-group">
                  <input type="email" class="form-control form-control-lg" name="email" id="email" placeholder="Email" required>
                </div>
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" name="cargo" id="cargo" placeholder="Cargo" pattern="[a-zA-ZÀ-ÿ\s]{1,20}" title="Sólo puede ingresar letras. Máximo 20 caracteres." required>
                </div> 
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" name="sueldo" id="sueldo" placeholder="Sueldo" pattern="\d{1,7}(\.\d{1,2})?" title="Ingrese máximo 7 números (máximo dos decimales opcionales, separador decimal: .") required>
                </div> 
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" name="usuario" id="usuario" placeholder="Usuario" pattern="[a-zA-Z0-9]{6,10}" title="Ingrese de 6 a 10 caracteres. Sólo letras y números." required>
                </div>
                <div class="form-group">
                  <input type="password" class="form-control form-control-lg" name="contrasenia" id="contrasenia" placeholder="Contraseña" pattern=".{4,12}" title="Ingrese de 4 a 12 caracteres." required>
                </div>
                <div class="mt-3">
                  <button type="submit" class="btn btn-block btn-primary btn-lg font-weight-medium empleados-form-btn" value="enviar" id="btn-enviar">Crear empleado</button>
                </div>
              </form>
            </div>
          </div>
