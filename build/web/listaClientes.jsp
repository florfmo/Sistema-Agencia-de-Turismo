...
<%@page import="java.util.List, java.util.Date, Logica.Controladora, Logica.Cliente, java.text.SimpleDateFormat"%>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        ...
                        %>
                          ...
                          <td>
                            <form name="frmModificarCliente" action="SvModificarCl" method="post">
                            <input type="hidden" name="id" value="<%=id%>">
                            <button type="submit" class="btn btn-outline-warning btn-icon-text"><i class="ti-reload btn-icon-prepend"></i>Editar</button>
                            </form>
                          </td>
                          <td>
                            <form name="frmEliminarCliente" action="SvEliminarCl" method="post">
                            <input type="hidden" name="id" value="<%=id%>">
