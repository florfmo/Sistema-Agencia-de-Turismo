        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <h6 class="font-weight-light">Ingrese los datos del cliente</h6>
              <form class="pt-3" action="SvCliente" method="POST" id="formulario">
                ...
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" name="direccion" id="direccion" placeholder="Dirección" pattern="[a-zA-ZÀ-ÿ0-9\s]{7,55}" title="Sólo puede ingresar letras y números. Máximo 55 caracteres." required>
                </div> 
                <div class="form-group">
                ...
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" name="nacionalidad" id="nacionalidad" placeholder="Nacionalidad" pattern="[a-zA-ZÀ-ÿ\s]{1,20}" title="Sólo puede ingresar letras. Máximo 20 caracteres." title="required">
                </div> 
                <div class="form-group">
                ...
                <div class="mt-3">
                  <button type="submit" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" value="enviar" id="btn-enviar">Crear cliente</button>
                </div>
              </form>
            </div>
          </div>
