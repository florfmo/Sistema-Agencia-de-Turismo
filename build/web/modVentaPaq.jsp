...
<%@page import="Logica.Cliente, Logica.Cliente, Logica.Empleado, Logica.ServicioTuristico, Logica.PaqueteTuristico, Logica.Venta, Logica.Controladora, java.text.SimpleDateFormat, java.util.Date, java.util.List"%>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <h4 class="card-title">Modificación de ventas de paquetes</h4>
                  ...
                  <form class="forms-sample" action="SvModificarVen" method="GET" id="formulario">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" id="paquete" name="paquete">
                        ...
                        %>
                        <option value="<%=paq.getCodigo_paquete()%>" <%=(paq.getCodigo_paquete() == paquete.getCodigo_paquete()) ? "selected" : ""%>>
